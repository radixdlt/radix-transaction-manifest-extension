    ...
    getTokenHoverInformation(tokenKind: TokenKind): Hover | undefined {
        switch (tokenKind) {
            ...
            case TokenKind.assertWorktopContainsByAmount:
                return new Hover(basicHoverInformation.assertWorktopContainsByAmount);
            case TokenKind.assertWorktopContainsByIds:
                return new Hover(basicHoverInformation.assertWorktopContainsByIds);
            ...
            case TokenKind.callMethodWithAllResources:
                return new Hover(basicHoverInformation.callMethodWithAllResources);
            ...
            case TokenKind.createProofFromAuthZoneByAmount:
                return new Hover(basicHoverInformation.createProofFromAuthZoneByAmount);
            case TokenKind.createProofFromAuthZoneByIds:
                return new Hover(basicHoverInformation.createProofFromAuthZoneByIds);
