...
abstract class HoverProvider implements vscode.HoverProvider {
    ...
    provideHover(
        ...
        let tokenKind: TokenKind | undefined = this.tokenKindAtPosition(document, position);
        if (tokenKind) {
    ...
    abstract getTokenHoverInformation(tokenKind: TokenKind): vscode.Hover | undefined;
    ...
    protected tokenOverlapsPosition(token: Token, position: vscode.Position): boolean {
