 ...
 */
class ParsingDiagnosticsProvider extends diagnostics_provider_1.default {
    // =======================================
    ...
    syntaxError(_recognizer, offendingSymbol, line, _charPositionInLine, message, _e) {
        ...
        this.diagnostics.push(new vscode.Diagnostic(new vscode.Range(line - 1, offending.charPositionInLine, line - 1, offending.charPositionInLine + offendingTokenLength + 1), `Parsing Error: ${message}`, vscode.DiagnosticSeverity.Error));
    }
}
exports.default = ParsingDiagnosticsProvider;
//# sourceMappingURL=parsing_diagnostics_provider%20copy.js.map